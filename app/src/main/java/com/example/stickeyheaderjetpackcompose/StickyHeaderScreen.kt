package com.example.stickeyheaderjetpackcompose
...
import com.example.stickeyheaderjetpackcompose.ui.theme.StickeyHeaderJetpackcomposeTheme
...
fun LazyColumnWithStickyHeader() {
    ...
    LazyColumn {
        groupItem.forEach { (header, items) ->
            {
                stickyHeader {
...
@Composable
fun GreetingPreview() {
    StickeyHeaderJetpackcomposeTheme {
        val item1 = Item("Apple","Very healthy", R.drawable.carrot)
